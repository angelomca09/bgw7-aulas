...
const (
	GetAllProductsQuery = "SELECT id, name, quantity, code_value, is_published, expiration, price, id_warehouse FROM products"
	...
	GetAllWarehousesQuery = "SELECT id, name, address, telephone, capacity FROM warehouses"
